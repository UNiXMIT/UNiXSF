...
### Tweaks
- Removed the code that created a Quixy and FTS hyperlink in the case. You should now use the Quixy or FTS QuickLink in the top right that gets the necessary details from the active case tab.4.1.5
