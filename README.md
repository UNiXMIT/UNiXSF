...
- [Troubleshooting](#troubleshooting)  
  - [Add/Remove access to a specific site](#addremove-access-to-a-specific-site)
...
### Add/Remove access to a specific site

#### Chrome/Edge
1. Click the three dots menu → Extensions → Manage Extensions
2. Find the extension you want to manage. Click Details.
3. In the section titled "Automatically allow access on the following sites":
    - Toggle 'Automatically allow access on the following sites'  
    or 
    - Toggle each site individually.  

#### Firefox

[Manage optional permissions for Firefox extensions.](https://support.mozilla.org/en-US/kb/manage-optional-permissions-extensions)
