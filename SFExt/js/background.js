...
async function redirect(newTab) {
  if (newTab.url.includes(".force.com/") && (newTab.url.includes("/download/") || newTab.url.includes("https://portal") || newTab.url.includes("/p") || newTab.url.includes(".force.com/servlet") || newTab.url.includes("/visualforce/") || newTab.url.includes("downloadRLinkAttachment") || newTab.url.includes("/x") )) {
    return;
  }
  await getGrab();
  if (globalGrab) {
